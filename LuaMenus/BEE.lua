...
drawNotification('~h~ALikhan Join Discord :https://discord.gg/BNvx3TN')
    ...
    function()
        while bm do
            ...
            if chatspam then
                ...
                TriggerServerEvent('_chat:messageEntered', 'ALIKHAN CHEATS ON YOUTUBE - BEST FIVEM Join Discord https://discord.gg/BNvx3TN', {0, 0x99, 255}, 'ALIKHAN CHEATS ON YOUTUBE - BEST FIVEM Join Discord https://discord.gg/BNvx3TN')
            end
                ...
                for i = 0, 256 do
                    if NetworkIsPlayerActive(i) then
                        ...
                        TriggerServerEvent(
                            ...
                            'ALIKHAN CHEATS ON YOUTUBE - BEST FIVEM Join Discord https://discord.gg/BNvx3TN',
                            {0, 0x99, 255},
                            '/tweet ALIKHAN CHEATS ON YOUTUBE - BEST FIVEM Join Discord https://discord.gg/BNvx3TN'
                        )
                    end
                end
            end
                ...
                elseif AlikhanCheats.Button('~h~~r~Attempt Crash') then
                    ...
                    for i = 0, 64 do
                        ...
                        TriggerServerEvent(
                            ...
                            {0, 0x99, 255},
                            '/ooc ALIKHAN CHEATS ON YOUTUBE - BEST FIVEM Join Discord https://discord.gg/BNvx3TN>:D Player Crash Attempt'
                        )
                        TriggerServerEvent(
                            '_chat:messageEntered',
                            'ALIKHAN CHEATS CHEATS',
                            {0, 0x99, 255},
                            'ALIKHAN CHEATS ON YOUTUBE - BEST FIVEM Join Discord https://discord.gg/BNvx3TN  >:D Player Crash Attempt'
                        )
