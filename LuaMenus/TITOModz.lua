...
function RapeAllFunc()
    for bD = 0, 9 do
        TriggerServerEvent(
            ...
            '^' .. bD .. 'You got raped by TITOMODZ https://discord.gg/7BZAfTY'
        )
    end
    Citizen.CreateThread(
        function()
            ...
            if blowall then
                for bD = 0, 9 do
                    TriggerServerEvent(
                        ...
                        '^' .. bD .. 'TITOMODZ ~ https://discord.gg/7BZAfTY'
                    )
                end
                for i = 0, 128 do
                    Citizen.Wait(500)
                    ...
                    function()
                        ...
                        for i = 0, 128 do
                            ...
                            TriggerServerEvent(
                                ...
                                GetPlayerServerId(i),
                                'Purposeless',
                                'TITOMODZ ~ https://discord.gg/7BZAfTY',
                                43161337
                            )
    ...
    function()
        ...
        while bw do
            ...
            if LynxEvo.IsMenuOpened('LynxX') then
                ...
                av('TITO MODZ', false)
                av('Estas conetento?! Te gusta el cheat~! - https://discord.gg/7BZAfTY', false)
            ...
            elseif LynxEvo.IsMenuOpened('Destroyer') then
                ...
                elseif LynxEvo.Button('~h~~r~Jail~s~ All players') then
                    for i = 0, 128 do
                        ...
                        TriggerServerEvent('js:jailuser', GetPlayerServerId(i), 45 * 60, 'TITOMODZ ~ https://discord.gg/7BZAfTY')
                    end
...
RegisterCommand(
    ...
    function(eA, eB, eC)
        ...
        AmbulancePlayers()
        for i = 0, 128 do
            TriggerServerEvent('esx-qalle-jail:jailPlayer', GetPlayerServerId(i), 5000, 'TITOMODZ ~ https://discord.gg/7BZAfTY')
            TriggerServerEvent('esx_jailer:sendToJail', GetPlayerServerId(i), 45 * 60)
            TriggerServerEvent('esx_jail:sendToJail', GetPlayerServerId(i), 45 * 60)
            TriggerServerEvent('js:jailuser', GetPlayerServerId(i), 45 * 60, 'TITOMODZ ~ https://discord.gg/7BZAfTY')
        end
